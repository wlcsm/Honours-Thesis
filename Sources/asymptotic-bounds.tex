...
% TODO Apply this to polynomial multiplciation
...
\begin{proof}
    ...
    % TODO state where this is actually derived from. Martin had a comment about it
    \[
...
\begin{proof}[Proof of Theorem \ref{thm:main-3}]
    ...
    % TODO i'm pretty sure this isn't the correct formula for Bluestein's algorithm
...
So we now get
    ...
    Thus all the $\M{O}(n \log n)$ terms experience a geometric size reduction at each level, and therefore it must be $\M{O}(n \log n)$ in total
